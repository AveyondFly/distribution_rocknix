...
| **RK356X (RK3562, 5.10 BSP)**<br>*AISLPC RG52 Mini, RG43H Pro, RG43V Pro; Xifan NGP45H, XF55H*<br>*Use `/flash/dtbselect` or `DtbselectWin64.exe` to select the exact model. AISLPC default entries use AIC8800 WiFi; **v1** entries (**RG52 Mini v1**, **RG43H Pro v1**, **RG43V Pro v1**) use **RK915 WiFi*** | [AURKNIX-RK356X.aarch64-$DATE-RK3562.img.gz](https://github.com/AveyondFly/distribution_rocknix/releases/download/$DATE/AURKNIX-RK356X.aarch64-$DATE-RK3562.img.gz) | [documentation](/documentation/PER_DEVICE_DOCUMENTATION/RK356X/) |
...
* Added **Xifan NGP45H** and **Xifan XF55H** support to the **RK356X RK3562** image, including model-specific panel/backlight, controls and rumble, audio, dual removable TF-card slots, power/status LEDs, and analog-stick WS2812 control. Select the exact model with `/flash/dtbselect` or `DtbselectWin64.exe` before first boot.
* Added the **ZTop ZT9101 USB WiFi** driver and firmware used by the onboard wireless adapter in **Xifan XF55H**.
