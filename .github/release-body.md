...
| **RK356X**<br>*AISLPC RG52 Mini (unified image)*<br>*Use `/flash/dtbselect` or `DtbselectWin64.exe` on the boot partition: default **RG52 Mini** for standard WiFi; **RG52 Mini v1** for **RK915 WiFi*** | [AURKNIX-RK356X.aarch64-$DATE.img.gz](https://github.com/AveyondFly/distribution_rocknix/releases/download/$DATE/AURKNIX-RK356X.aarch64-$DATE.img.gz) | [documentation](/documentation/PER_DEVICE_DOCUMENTATION/RK356X/) |
