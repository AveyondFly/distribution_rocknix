...
|Nintendo|Game Boy Advance (gba)|2001|`gba`|.gba .zip .7z|**retroarch:** gpsp_ezode_32b (default)<br>**retroarch:** mgba<br>**retroarch:** vbam<br>**retroarch:** vba_next<br>**retroarch:** beetle_gba<br>**retroarch:** gpsp<br>**retroarch:** gpsp_ezode_32b (default)<br>**retroarch:** mgba<br>|
|Nintendo|Game Boy Advance (Hacks) (gbah)|2001|`gbah`|.gba .zip .7z|**retroarch:** vbam<br>**retroarch:** vba_next<br>**retroarch:** beetle_gba<br>|
...
|Nintendo|Nintendo DS (nds)|2005|`nds`|.nds .zip .7z|**drastic:** drastic_adv-sa<br>**drastic:** drastic-sa (default)<br>**retroarch:** melonds<br>**retroarch:** melondsds<br>**melonds:** melonds-sa<br>|
...
|Sega|Genesis (genesis)|1989|`genesis`|.bin .gen .md .sg .smd .zip .7z|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** genesis_plus_gx_EX<br>**retroarch:** genesis_plus_gx_wide<br>**retroarch:** picodrive<br>**retroarch:** genesis_plus_gx_EX<br>**retroarch:** genesis_plus_gx_EX<br>**retroarch:** genesis_plus_gx_EX<br>|
...
|Sony|PlayStation (psx)|1994|`psx`|.bin .cue .img .mdf .pbp .toc .cbn .m3u .ccd .chd .iso|**retroarch:** pcsx_rearmed (default)<br>**retroarch:** beetle_psx<br>**retroarch:** pcsx_rearmed_rumble_32b<br>**duckstation:** duckstation-sa<br>**retroarch:** swanstation<br>|
|Sony|PlayStation 2 (ps2)|2000|`ps2`|.iso .mdf .nrg .bin .img .dump .gz .cso .chd|**aethersx2:** aethersx2-sa (default)<br>|
|Sony|PlayStation Portable (psp)|2004|`psp`|.iso .cso .pbp .chd|**ppsspp:** ppsspp2021-sa<br>**ppsspp:** ppsspp-sa (default)<br>**retroarch:** ppsspp<br>**ppsspp:** ppsspp-sa (default)<br>**ppsspp:** ppsspp2021-sa<br>|
