...
ALL_DEVICES: Dict[str, DtbEntry] = {
    ...
    "Game Console R50H": DtbEntry("rk3326-gameconsole-r50h.dtb", 202,),
...
CATEGORIES: Dict[str, Dict[str, DtbEntry]] = {
    ...
    "其他": {
        ...
        "GameConsole R36 Ultra": ALL_DEVICES["R36 Ultra"],
        "GameConsole R36 Ultra v2": ALL_DEVICES["R36 Ultra v2"],
        "GameConsole R36 Ultra X": ALL_DEVICES["R36 Ultra X"],
...
DEVICE_TRANSLATIONS = {
    ...
    "Game Console R50H": "Game Console R50H",
