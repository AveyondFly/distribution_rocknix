...
PKG_NAME="flycast2022-sa"
PKG_VERSION="aa97a6d64fb47d3ce0febaa575b26d975dd916e4" #v2.0
PKG_LICENSE="GPLv2"
PKG_SITE="https://github.com/flyinghead/flycast"
PKG_URL="${PKG_SITE}.git"
PKG_DEPENDS_TARGET="toolchain alsa SDL2 libzip zip curl miniupnpc lua54 libao flycast-sa"
...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/.${TARGET_NAME}/flycast ${INSTALL}/usr/bin/flycast2022
