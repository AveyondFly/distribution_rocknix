...
PKG_EMUS="amiberry flycast-sa flycast2022-sa gzdoom-sa hatarisa hypseus-singe moonlight mupen64plus-sa openbor openbor-ff free-j2me pico-8 ppsspp-sa vice-sa wine cpymo mrp-sa krkr2-sa eka2l1-sa onscripter-sa ruffle-sa"
EMUS_32BIT=""
...
LIBRETRO_CORES="81-lr a5200-lr arduous-lr atari800-lr b2-lr beetle-gba-lr beetle-lynx-lr beetle-ngp-lr beetle-pce-lr beetle-pce-fast-lr    \
                ...
                dosbox-core-lr dosbox-pure-lr easyrpg-lr emuscv-lr fake08-lr fbalpha2012-lr native32emu-lr                              \
                ...
                opera-lr parallel-n64-lr pcsx_rearmed-lr picodrive-lr pokemini-lr potator-lr ppsspp-lr prosystem-lr puae-lr         \
                puae2021-lr px68k-lr quasi88-lr quicknes-lr race-lr same_cdi-lr sameboy-lr sameduck-lr scummvm-lr smsplus-gx-lr     \
                snes9x-lr snes9x2002-lr snes9x2005_plus-lr snes9x2010-lr stella-lr swanstation-lr tgbdual-lr theodore-lr tic80-lr  \
                uzem-lr vba-next-lr vbam-lr vecx-lr vice-lr vircon32-lr virtualjaguar-lr xmil-lr wasm4-lr yabasanshiro-lr fbneoplus-lr"
...
case "${DEVICE}" in
  ...
  RK3399)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="box86 desmume-lr gpsp-lr gpsp_ezode-lr pcsx_rearmed-lr"
    PKG_EMUS+=" aethersx2-sa box64 dolphin-sa drastic-sa drastic_adv-sa mednafen melonds-sa nanoboyadvance-sa portmaster scummvmsa \
  ...
  RK3588)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="box86 desmume-lr gpsp-lr gpsp_ezode-lr pcsx_rearmed-lr"
    PKG_EMUS+=" aethersx2-sa azahar-sa box64 dolphin-sa drastic-sa drastic_adv-sa mednafen melonds-sa portmaster scummvmsa supermodel-sa yabasanshiro-sa duckstation-sa"
  ...
  SDM845|SM8250|SM8550|SM8650)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="box86 daedalusx64-sa desmume-lr gpsp-lr gpsp_ezode-lr pcsx_rearmed-lr"
  ...
  S922X)
    ...
    PKG_EMUS+=" aethersx2-sa azahar-sa box64 dolphin-sa drastic-sa drastic_adv-sa duckstation-sa melonds-sa portmaster scummvmsa yabasanshiro-sa"
...
makeinstall_target() {
  ...
  ### Commodore Amiga
  case ${DEVICE} in
    H700|RK3326*|RK3399|RK3566|RK356X|A527|RK3588|SDM845|SM8250|SM8550|SM8650)
  ...
  ### Homebrew MAME
  add_emu_core hbmame retroarch fbalpha2012_32b true
  add_emu_core hbmame retroarch nebularm_32b false
  add_emu_core hbmame retroarch nebularm_legacy_32b false
  ...
  ## Sammy Atomiswave
  case ${DEVICE} in
    H700|RK3326*|RK3399|RK3566|RK356X|A527|RK3588|S905)
  ...
  case ${DEVICE} in
    H700|RK3326*|RK3399|RK3566|RK356X|A527|RK3588|SM8250|SM8550|SM8650)
  ...
  case ${DEVICE} in
    H700|RK3326*|RK3566|RK356X|A527|S905|S922X)
  ...
  case ${DEVICE} in
    H700|RK3326*|RK3399|RK3566|RK356X|A527|RK3588|SM8250|SM8550)
  ...
  case ${DEVICE} in
    RK3399|SDM845|SM8250|SM8550|SM8650)
      ...
      ;;
    RK3566|RK356X|A527|RK3588|S922X)
  ...
  add_emu_core j2me retroarch freej2me false
  add_emu_core j2me freej2me freej2me true
  add_es_system j2me

  ### BBK Electronic Dictionary
  add_emu_core bbk retroarch gam4980 true
  add_es_system bbk
  ...
  ### Native32Emu
  add_emu_core native32emu retroarch native32emu true
  add_es_system native32emu
  ...
  case ${DEVICE} in
    H700|RK3326*)
      ...
      ;;
    RK3399|RK3566|RK356X|A527|RK3588)
      add_emu_core nds drastic drastic_adv-sa true
      add_emu_core nds drastic drastic-sa false
      add_emu_core nds retroarch melonds false
      add_emu_core nds retroarch melondsds false
  ...
  ### Adobe Flash
  add_emu_core flash ruffle ruffle-sa true
  add_es_system flash
  ...
  ### Kirikiri2 / KrKr2
  add_emu_core krkr2 krkr2 krkr2 true
  add_es_system krkr2
